...
namespace whale {
	...
	struct DiagCodedType {
		/*
		* Types:
		*	 1) STANDARD-LENGTH-TYPE:
		*			{ BASE-TYPE-ENCODING="BCD-P", 
		*			  BASE-DATA-TYPE="A_UINT32", 
		*			  <BIT-LENGTH>24</BIT-LENGTH>,
		*			  <BIT-MASK>0F</BIT-MASK>,
		*			  IS-HIGHLOW-BYTE-ORDER="true"
		*			},
		*    2) MIN-MAX-LENGTH-TYPE:
		*			{ TERMINATION="ZERO",
		*			  BASE-DATA-TYPE="A_ASCIISTRING",
		*			  <MAX-ENGTH>16</MAX-LENGTH>,
		*			  <MIN-LENGTH>0</MIN-LENGTH> 
		*			},
		*	 3)	LEADING-LENGTH-INFO-TYPE: 
		*			{ BASE-DATA-TYPE="A_ASCIISTRING",
		*			  <BIT-LENGTH>8</BIT-LENGTH>
		*			},
		*	 4) PARAM-LENGTH-INFO-TYPE:
		*			{ BASE-DATA-TYPE="A_BYTEFIELD",
		*			      <LENGTH-KEY-REF ID-REF="Req_RoutiContrCheckMemor.Param_LengtInfor" />
		*           }
		* }
		*/
		String						m_xsiType;
		...
		std::optional<Reference>	m_lengthKeyRef;
	...
	struct DataObjectProp : public DopBase {
		struct CompuMethod {
			/*
			* A compute method could be in category:
			* 
			* a) IDENTICAL
			* b) TEXTTABLE
			* c) LINEAR
			* 
			* == For TEXTTABLE ==
			* COMPU-INTERNAL-TO-PHYS consists of Compute Scales:
			* { <COMPU-SCALE>
            *     <LOWER-LIMIT>6</LOWER-LIMIT>
            *     <UPPER-LIMIT>15</UPPER-LIMIT>
            *     <COMPU-CONST>
            *       <VT TI="MAS15826">Routine System Supplier Defined Reached Status</VT>
            *     </COMPU-CONST>
            *   </COMPU-SCALE>
			* }
			* 
			* Problem: why need a upper limit for text table item?
			*/
			...
			/*
			* == For LINEAR ==
			* COMPU-INTERNAL-TO-PHYS consists of vec of Compu-Scales:
			* <COMPU-SCALES>
            *   <COMPU-SCALE>
			*     <DESC>
            *       <p>Dia_Anp_159</p>
