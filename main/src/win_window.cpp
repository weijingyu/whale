...
namespace Whale {
    ...
    void Window::initNative() {
        ...
        constexpr static LPCWSTR UniqueMutexId = L"ImHex/a477ea68-e334-4d07-a439-4f159c683763";
    ...
    void Window::setupNativeWindow() {
        ...
        bool borderlessWindowMode = Whale::System::isBorderlessWindowModeEnabled();
    ...
    void Window::endNativeWindowFrame() {
        if (!Whale::System::isBorderlessWindowModeEnabled())
            return;
   ...
   /* void Window::drawTitleBar() {
        if (!Whale::System::isBorderlessWindowModeEnabled()) return;
